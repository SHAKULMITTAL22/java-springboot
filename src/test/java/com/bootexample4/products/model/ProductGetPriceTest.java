...
public class ProductGetPriceTest {
	...
	public void getPriceWithPositiveValue() {
		...
		double actual = product.getPrice();
		assertEquals(expected, actual, "The returned price should match the set positive value");
	}
	...
	public void getPriceWithNegativeValue() {
		...
		double actual = product.getPrice();
		assertEquals(expected, actual, "The returned price should match the set negative value");
	}
	...
	public void getPriceWithZeroValue() {
		...
		double expected = 0.0;
		double actual = product.getPrice();
		assertEquals(expected, actual, "The returned price should be 0.0 when explicitly set to zero");
	}
