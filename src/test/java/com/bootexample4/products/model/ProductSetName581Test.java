...
public class ProductSetName581Test {
	...
	public void setNameWithNull() {
		...
		// Assert
		assertNull(product.getName(), "The name should be updated to null");
	}
	...
	public void setNameWithVeryLongString() {
		...
		assertEquals(longName, product.getName(),
				"The name should be updated to a very long string of 1000 characters");
	}
