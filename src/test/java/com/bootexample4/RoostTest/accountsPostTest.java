...
public class accountsPost_Test {
    ...
    private static final String CSV_FILE = "src/test/java/com/bootexample4/RoostTest/accountsPostTest.csv";
    ...
    public void com.bootexample4() {
        ...
        List<Map<String, String>> testData = readCSVData(CSV_FILE);

        for (Map<String, String> data : testData) {
            // Prepare request body
            JSONObject requestBody = new JSONObject();
            // Set request body parameters based on CSV data
            // Example: requestBody.put("key", data.get("value"));
            ...
            // Example: String value = jsonPath.getString("key");
        }
    }

    private List<Map<String, String>> readCSVData(String csvFile) {
        List<Map<String, String>> testData = new ArrayList<>();
        // Read CSV file and populate testData list
        ...
        //     // Populate data map based on CSV columns
        //     testData.add(data);
        // }
        return testData;
    }
