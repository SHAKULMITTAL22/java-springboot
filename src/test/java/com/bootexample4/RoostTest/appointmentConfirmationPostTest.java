...
public class appointmentConfirmationPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/appointmentConfirmationPostTest.csv", envVarsList);
    }

  
    @Test  
    public void appointmentConfirmationPost_Test() throws JSONException {
        this.setUp();
