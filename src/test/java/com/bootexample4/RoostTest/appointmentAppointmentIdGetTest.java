...
Test generated for /appointment/{appointmentId}_get for http method type GET in rest-assured framework

RoostTestHash=c8dc79a832
...
public class appointmentAppointmentIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/appointment_appointmentIdGetTest.csv", envVarsList);
    }

  
    @Test  
    public void appointmentAppointmentIdGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: appointmentAppointmentIdGet_Test \n", testNumber++);
              System.out.println("Request: GET /appointment/{appointmentId}");
