...
Test generated for /searchTimeSlot_get for http method type GET in rest-assured framework

RoostTestHash=9a533ce2b4
...
public class searchTimeSlotGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/searchTimeSlotGetTest.csv", envVarsList);
    }

  
    @Test  
    public void searchTimeSlotGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("addressId", testData.get("addressId") != null ? testData.get("addressId") : "")
				.queryParam("subscriberId", testData.get("subscriberId") != null ? testData.get("subscriberId") : "")
				.queryParam("associatedDocument", testData.get("associatedDocument") != null ? testData.get("associatedDocument") : "")
				.queryParam("startDate", testData.get("startDate") != null ? testData.get("startDate") : "")
				.queryParam("finishDate", testData.get("finishDate") != null ? testData.get("finishDate") : "")
				.queryParam("orderType", testData.get("orderType") != null ? testData.get("orderType") : "")
				.queryParam("addressChangeFlag", testData.get("addressChangeFlag") != null ? testData.get("addressChangeFlag") : "")
				.queryParam("productType", testData.get("productType") != null ? testData.get("productType") : "")
				.queryParam("priorityFlag", testData.get("priorityFlag") != null ? testData.get("priorityFlag") : "")
				.queryParam("priorityReason", testData.get("priorityReason") != null ? testData.get("priorityReason") : "")
                .when()
                .get("/searchTimeSlot")  
                .then() 
                .extract().response(); 
              ...
              System.out.printf("Test Case %d: searchTimeSlotGet_Test \n", testNumber++);
              System.out.println("Request: GET /searchTimeSlot");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(200,400,401,403,404,406,412,429,500,503,504);
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("slots") != null) {
                        
                  for (int i = 0; i < response.getList("slots").size(); i++) {      
              if (response.get("slots["+ i +"].id") != null) {
                  
                MatcherAssert.assertThat(response.get("slots["+ i +"].id"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("slots["+ i +"].id").length(), lessThanOrEqualTo(36));

              }
      
              if (response.get("slots["+ i +"].startDate") != null) {
                  
                MatcherAssert.assertThat(response.get("slots["+ i +"].startDate"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("slots["+ i +"].startDate").length(), lessThanOrEqualTo(25));

              }
      
              if (response.get("slots["+ i +"].finishDate") != null) {
                  
                MatcherAssert.assertThat(response.get("slots["+ i +"].finishDate"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("slots["+ i +"].finishDate").length(), lessThanOrEqualTo(25));

              }
      
              if (response.get("slots["+ i +"].expireIn") != null) {
                  
                MatcherAssert.assertThat(response.get("slots["+ i +"].expireIn"), instanceOf(Integer.class));  
                MatcherAssert.assertThat(response.getString("slots["+ i +"].expireIn").length(), lessThanOrEqualTo(4));

              }
        
                    }    
                MatcherAssert.assertThat(response.getList("slots"), instanceOf(List.class));
