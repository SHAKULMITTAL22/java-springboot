...
public class appointmentPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/appointmentPostTest.csv", envVarsList);
    }

  
    @Test  
    public void appointmentPost_Test() throws JSONException {
        this.setUp();
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(201,400,401,403,404,406,412,423,429,500,503,504);
