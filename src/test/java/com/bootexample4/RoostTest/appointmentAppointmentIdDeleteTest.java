...
Test generated for /appointment/{appointmentId}_delete for http method type DELETE in rest-assured framework

RoostTestHash=ba223e1b3d
...
public class appointmentAppointmentIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/appointment_appointmentIdDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void appointmentAppointmentIdDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.queryParam("appointmentReason", testData.get("appointmentReason") != null ? testData.get("appointmentReason") : "")
				.queryParam("appointmentComments", testData.get("appointmentComments") != null ? testData.get("appointmentComments") : "")
              ...
              System.out.printf("Test Case %d: appointmentAppointmentIdDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /appointment/{appointmentId}");
